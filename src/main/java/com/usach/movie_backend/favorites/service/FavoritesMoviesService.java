...
public class FavoritesMoviesService implements IFavoritesMoviesService{
    ...
    @Transactional(readOnly = true)
    public FavoriteMovies findFavoriteMovies(FavoriteMovieGet favoriteMovieGet){
        ...
        FavoriteMovies favoriteMovieList = new FavoriteMovies(favorite.getIdFavorite(),movies);
